...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // подкючение библиотеки в главный файл


__webpack_require__(/*! ../style/blocks/header/__navBox/slideMenu */ "./resources/style/blocks/header/__navBox/slideMenu.js");
...
/***/ "./resources/style/blocks/header/__navBox/slideMenu.js":
/*!*************************************************************!*\
  !*** ./resources/style/blocks/header/__navBox/slideMenu.js ***!
  \*************************************************************/
/***/ (() => {
...
var SlideMenu = /*#__PURE__*/_createClass(function SlideMenu(data) {
  var _this = this;

  _classCallCheck(this, SlideMenu);

  _defineProperty(this, "addEventListeners", function () {
    var self = _this; // действие при нажатии на кнопку МЕНЮ

    _this.buttonToggleMenu.addEventListener('click', function () {
      self.toggleMenu();
    ...
    _this.buttonFind.addEventListener('click', function () {
      self.toggleSearch();
    }); // действие при нажатии на кнопку КРЕСТИК В ПОИСКЕ


    _this.buttonSearchClose.addEventListener('click', function () {
      self.toggleSearch();
  ...
  _defineProperty(this, "eventButtonCategories", function () {
    var self = _this;

    _this.arrayButtonMenuCategoryTagsId.forEach(function (buttonCategory) {
      // получаю id кнопки
      var id = buttonCategory.getAttribute("data-categoryId"); // ищу панель с таким же id

      _this.arrayPanelMenuTagsId.forEach(function (panelMenuTags) {
        var idPanel = panelMenuTags.getAttribute("data-categoryPanelId");
  ...
  _defineProperty(this, "toggleMenu", function () {
    _this.mainBoxMenu.classList.toggle('header__navBox-main_visible');

    _this.backgroundMenu.classList.toggle('header__navBox-background_blurred');
  });

  _defineProperty(this, "toggleSearch", function () {
    _this.search.classList.toggle('header_search_visible');

    _this.backgroundSearch.classList.toggle('header__searchBox-background_blurred');
  });
  ...
  this.mainPanelMenu = data['mainPanelMenu']; // перенес поиск элементов элементы которым необходимо зназначить событие в конструктор

  this.buttonToggleMenu = data['buttonToggleMenu'];
  this.buttonClose = data['buttonClose'];
  this.buttonFind = data['buttonFind'];
  this.buttonSearchClose = data['buttonSearchClose']; // Запускаю функции назначения слушателя событий на кнопки
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/style"], () => (__webpack_require__("./resources/style/style.scss")))
